({
    ...
    handleTheComponentEvent: function (component, event, helper) {

        var selectedUser = event.getParam("recordByEvent");
        //alert('selectedUser1'+selectedUser);
        component.set("v.selectedRecord", selectedUser);

        //var userid=JSON.stringify(selectedUser);
        //alert('userid'+userid);
